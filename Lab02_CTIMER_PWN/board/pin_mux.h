...
/*! @name PIO1_4 (number 1), R78/P18[5]/LEDR/PWM_ARD
  @{ */
#define MY_INITCTIMEROUTS_LED_BLUE_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define MY_INITCTIMEROUTS_LED_BLUE_PIN 4U                   /*!<@brief PORT pin number */
#define MY_INITCTIMEROUTS_LED_BLUE_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                            /* @} */

/*! @name PIO1_7 (number 9), R79/P18[7]/LEDG/PWM_ARD
  @{ */
#define MY_INITCTIMEROUTS_LED_GREEN_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define MY_INITCTIMEROUTS_LED_GREEN_PIN 7U                   /*!<@brief PORT pin number */
#define MY_INITCTIMEROUTS_LED_GREEN_PIN_MASK (1U << 7U)      /*!<@brief PORT pin mask */
                                                             /* @} */
 ...
 *
 */
void My_InitCTIMEROuts(void); /* Function assigned for the Cortex-M33 (Core #0) */
